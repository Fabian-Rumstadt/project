"use strict"
//need to change back fetch function to "http://192.168.0.64:5000/status"
var main = document.getElementsByClassName("main") /*Definition globale Variablen*/
...
function lock() {
    ...
    fetch('http://192.168.178.63:5000/action/lock');
...
function unlock() {
    ...
    fetch('http://192.168.178.63:5000/action/unlock');
...
function openLeft() {
    ...
    fetch('http://192.168.178.63:5000/action/windowdown');
...
function closeLeft() {
    ...
    fetch('http://192.168.178.63:5000/action/windowup');
